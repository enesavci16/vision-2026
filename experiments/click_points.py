...
if __name__ == "__main__":
    ...
    print("--- INSTRUCTIONS ---")
    print("1. Find a real-world rectangle on the road (e.g., a lane segment between dashed lines).")
    print("2. Click 4 points in this EXACT order: Top-Left, Top-Right, Bottom-Left, Bottom-Right.")
    print("--------------------\n")
