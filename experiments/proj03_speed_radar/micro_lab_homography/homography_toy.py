...
def calculate_homography_matrix(src_pts: np.ndarray, dst_pts: np.ndarray) -> np.ndarray:
    """
...
def generate_birds_eye_view(
    image: np.ndarray, matrix: np.ndarray, output_size: Tuple[int, int]
) -> np.ndarray:
    """
...
if __name__ == "__main__":
    ...
    save_path_1 = (
        r"experiments\proj03_speed_radar\micro_lab_homography\01_original_with_dots.jpg"
    )
    save_path_2 = (
        r"experiments\proj03_speed_radar\micro_lab_homography\02_birds_eye_view.jpg"
    )
